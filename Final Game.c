...
printf("                   CANON ENDING: Val Embraces the Dark Magic!\n\n\n");
...
Delay(500);
printf("the heart of the dungeon. There, she finds an ancient sword pulsating with dark\n");
Delay(500);
...
pthread_t tid;
pthread_create(&tid, NULL, beep_thread, NULL);
printf("                   ALTERNATIVE ENDING: Val Rejects the Dark Magic!\n\n\n");
    ...
    while (hp > 0){
        ...
        case 'W':
            ...
            if (map4[playerY - 1][playerX] != '*' && map4[playerY - 1][playerX] != 'J'){        // up
				...
				if((playerY + 1 == monster3Y || playerY == monster3Y || playerY - 1 == monster3Y)  && (playerX + 1 == monster3X || playerX == monster3X || playerX - 1 == monster3X))
				{
					playerX = 1, playerY = 13;
					hp--;
				}	
        ...
        case 'A':
            ...
            if (map4[playerY][playerX - 1] != '*' && map4[playerY][playerX - 1] != 'J'){        // left
				...
				if (playerY == 13 && playerX == 3) {
           		...
           		if((playerY + 1 == monster3Y || playerY == monster3Y || playerY - 1 == monster3Y)  &&
				 (playerX + 1 == monster3X || playerX == monster3X || playerX - 1 == monster3X))
				{
					playerX = 1, playerY = 13;
					hp--;
				}
